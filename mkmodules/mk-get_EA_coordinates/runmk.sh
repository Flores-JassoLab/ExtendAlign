...
## The names of the final targets for mk will be defined by replacing the .blastn.tsv or .blastnbesthit.tsv extension with: ".EAcoordinates.tsv"
...
| sed \
    -e "s#.blastn.tsv#.EAcoordinates.tsv#" \
    -e "s#.blastnbesthit.tsv#.EAcoordinates.tsv#" \
| xargs mk $@
